...
export default function TeenPatti3Settings() {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-foreground mb-2">Teen Patti 3 Settings</h1>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
                ...
                <p className="text-sm text-muted-foreground mb-4 flex items-center gap-2">
                    ...
                    Values represent probability distribution
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {Object.entries(winningPercentage).map(([key, value]) => (
                        <div key={key} className="space-y-2">
                            <label className="text-sm font-medium text-foreground capitalize">
                                {percentageLabels[key as keyof typeof percentageLabels]}
                            </label>
                            <input
                                type="number"
                                step="0.1"
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
                    <div className="bg-card border border-border rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl">
                        ...
                        <p className="text-muted-foreground mb-6">
                            This action cannot be undone. All game records for Teen Patti 3 will be permanently deleted.
                        </p>

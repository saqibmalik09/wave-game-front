...
const generateMockLogs = (): GameLog[] => {
    ...
    for (let i = 0; i < 45; i++) {
        ...
        logs.push({
            ...
            gameRoundId: `GR-${Math.floor(Math.random() * 9000) + 1000}`,
            userBet,
...
export default function GreedyTeenPattiLogs() {
    ...
    return (
        <div className="space-y-5">
            {/* Header */}
            <div>
                <h1 className="text-2xl font-bold text-foreground mb-1">Greedy Teen Patti Logs</h1>
                <p className="text-sm text-muted-foreground">Game ID: 1 • View all game rounds and user activity</p>
            </div>

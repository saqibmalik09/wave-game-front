...
const Wheel = forwardRef<WheelRef, WheelProps>(({ onCabinClick, animateCoin }, ref) => {
    ...
    const winningCabinIndex = 4;

    // Use spin effect
    const spinState = useCabinSpinEffect(currentPhase, winningCabinIndex);
    ...
    return (
        ...
        <div className="relative w-full max-w-[280px] aspect-square">
            ...
            {cabins.map((cabin) => {
                ...
                const isWinner = spinState.isWinnerHighlighted && cabin.index === winningCabinIndex;
                ...
                return (
                    <div
                        ...
                        className={`absolute ${cabin.pos} -translate-x-1/2 -translate-y-1/2
                                ...
                                ${isWinner ? 'border-4 border-green-400 shadow-[0_0_20px_rgba(74,222,128,0.8)]' : ''}`}
                        style={{

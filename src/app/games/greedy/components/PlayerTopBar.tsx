...
const PlayerTopBar = forwardRef<HTMLButtonElement>((props, ref) => {
  return (
    <button
      ref={ref}
      className="w-9 h-9  overflow-hidden shadow-md bg-gradient-to-br from-[#FF8904] to-[#FF6B00] flex items-center justify-center hover:scale-105 transition-transform"
